...
result = Compound([inset, outset])

# Also export as GLB for viewing (3MF already exported above)
from build123d import export_gltf
export_gltf(result, "./dual_color.glb", binary=True)
print("Exported dual_color.3mf and dual_color.glb")
