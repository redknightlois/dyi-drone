...
result = roller_coaster.line

# Export GLB (note: this is a wire/curve, not a solid)
from build123d import export_gltf
export_gltf(result, "./roller_coaster.glb", binary=True)
print("Exported roller_coaster.glb")
